...
## Overview
Sparse Component Analysis (SCA) is an unsupervised dimensionality reduction method that can recover latent factors corresponding to distinct computations, from high dimensional neural activity. This repo. contains notebooks (and example data) that demonstrate how to use SCA. For a full characterization of the method (and to see results from additional datasets) see our [manuscript](https://www.cell.com/neuron/fulltext/S0896-6273(26)00414-9).
...
### Responsible Use
We highly recommend reading the "Responsible Use of SCA" subsection of Methods within our manuscript. As just a couple very brief points here:
